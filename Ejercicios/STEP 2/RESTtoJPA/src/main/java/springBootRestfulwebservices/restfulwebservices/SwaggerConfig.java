...
public class SwaggerConfig {
	public static final Contact DEFAULT_CONTACT = new Contact("David Castilla", "www.dchcobra.es", "dchcobra@gmail.com");
	...
	private static final Set<String> DEFAULT_PRODUCES_AND_CONSUMES = new HashSet<String>(
			Arrays.asList("applications/json", "application/xml"));
