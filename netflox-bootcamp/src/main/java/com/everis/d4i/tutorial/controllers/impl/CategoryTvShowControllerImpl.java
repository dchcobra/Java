...
public class CategoryTvShowControllerImpl implements CategoryTvShowController {
	...
	public NetflixResponse<List<CategoryTvShowRest>> getCategoryTvShowByTvShow(@PathVariable(value = "tvShowId"
	, name = "tvShowId") int tvShowId ) throws NetflixException {
	...
	public NetflixResponse<CategoryTvShowRest> AddCategoryToTvShow(
			@ApiParam(value = RestConstants.PARAMETER_CATEGORY, required = true) 
			@RequestBody @Valid CategoryTvShowRest categoryTvShowRest) throws NetflixException {
		return new NetflixResponse<>(CommonConstants.SUCCESS, String.valueOf(HttpStatus.OK), CommonConstants.OK,
				categoryTvShowService.addCategoryToTvShow(categoryTvShowRest));
	}
}
